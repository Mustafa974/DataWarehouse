...
class DBManager(object):
    ...
    def __init__(self):
        ...
        self.db = self.client[config.HLT_DB_str]
    ...
    def update_attr(self, src, name, attr_name, data):
        """
        为指定数据库更新字段，指定内容
        :param src:
        :param attr_name:
        ...
        src_col = self.db[src]
        src_col.create_index('movieName')
        if src_col.update({'movieName': name}, {"$set": {attr_name: data}}):
